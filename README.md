...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p b9eee2be-90d5-42b0-bd9a-f1b468366bc5
```

> `b9eee2be-90d5-42b0-bd9a-f1b468366bc5` is the password of the certificate, you can change it to any password you want.
